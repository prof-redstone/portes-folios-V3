...
function checkInstance(){
    if(document.getElementsByClassName("snowflake").length > 0){ //insert the class's name of canvas elements
        var documentInstanceOfSnowflake = document.getElementsByClassName("snowflake")
...
function Snow_flake(theNumberOfSnowFlakeInstance, IDcanvas){
    ...
    this.setup = function(){
        ...
        for(var i = 0; i < this.numberOfBoule; i++){
            this.collectionOfBoule[i] = new this.boule(this.canvas.width, this.canvas.height, this.ctx, this.moveOption, this.spaceLeft, this.spaceTop);
        }
    ...
    this.boule = function(maxWidth, maxHeigth, ctx, moveOption, spaceLeft, spaceTop){
...
//Author Tom Demagny
//Date of creation 11/24/19
//please don't delete my name, kisses ;)